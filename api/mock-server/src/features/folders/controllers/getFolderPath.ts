...
export const newGetFolderPathController = (
  deps: MockApiDependencies,
): Pick<ProductMockControllers, "getFolderPath"> => ({
  getFolderPath: async (input) => deps.foldersService.getFolderPath(input.path.folderId),
})
